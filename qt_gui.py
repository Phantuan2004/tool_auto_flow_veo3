...
class FlowStudio(QMainWindow):
    ...
    def _build_ui(self):
        ...
        config_panel.setMinimumWidth(760)
        ...
        self.media.setMinimumWidth(420)
        self.media.setMinimumHeight(360)
        right_layout.addWidget(self.media, 3)
        ...
        main_splitter.setSizes([1500, 800])
    ...
    def _build_config_panel(self):
        ...
        self.scene_list.setMinimumHeight(240)
        ...
        layout.addWidget(self.reference_list, 2)
